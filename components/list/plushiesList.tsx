...
type SizeFilter = "all" | "mini" | "small" | "medium" | "large"
...
export default function PlushiePage() {
  ...
  const filteredAndSortedProducts = useMemo(() => {
    const filtered = featuredPlushies.filter((plushie) => {
      ...
      const matchesNew = !showOnlyNew || plushie.isNew
      const matchesOnSale = !showOnSale || (plushie.originalPrice && plushie.originalPrice > plushie.price)
      
      const matchesSize = sizeFilter === "all" || 
        (sizeFilter === "mini" && plushie.size.toLowerCase().includes("mini")) ||
        (sizeFilter === "small" && plushie.size.toLowerCase().includes("small")) ||
        (sizeFilter === "medium" && plushie.size.toLowerCase().includes("medium")) ||
        (sizeFilter === "large" && plushie.size.toLowerCase().includes("large"))
      
      const matchesSeries = seriesFilter === "all" || plushie.series === seriesFilter
      
      return matchesSearch && matchesNew && matchesOnSale && matchesSize && matchesSeries
    })
      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600 max-w-2xl mx-auto">
            Discover our adorable collection of anime and character plushies - perfect for cuddling and collecting
          </p>
        ...
        <div className="bg-white rounded-xl shadow-lg p-6 mb-8">
          <div className="flex flex-col lg:flex-row gap-4 items-center justify-between">
            ...
            <div className="relative flex-1 max-w-md">
              ...
              <input
                type="text"
                placeholder="Search plushies, characters, or series..."
                value={searchTerm}
        ...
        <div className="mb-6 flex flex-col sm:flex-row sm:items-center sm:justify-between">
          <p className="text-gray-600">
            Showing {startIndex + 1}-{Math.min(endIndex, totalItems)} of {totalItems} plushies
          </p>
          {totalPages > 1 && (
        ...
        {currentItems.length > 0 ? (
          ...
          <div className="text-center py-16">
            ...
            <h3 className="text-xl font-semibold text-gray-600 mb-2">No plushies found</h3>
        ...
        <div className="mt-16 bg-white rounded-xl shadow-lg p-8">
          <div className="grid md:grid-cols-4 gap-8 text-center">
            ...
            <div>
              ...
              <div className="text-gray-600">Different Series</div>
            </div>
            <div>
              <div className="text-3xl font-bold text-pink-500 mb-2">
