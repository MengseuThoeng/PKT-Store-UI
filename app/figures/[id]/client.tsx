...
export default function FigureDetailsClient({ params }: { params: { id: string } }) {
      ...
      {figure && (
        <StructuredData 
          data={generateProductSchema({
            ...
            name: figure.name,
            description: figure.description || `Premium ${figure.name} figure from ${figure.series || 'Anime'} series`,
            price: figure.price,
            image: figure.image,
