    ...
    <AdminLayout>
      ...
      <div className="max-w-4xl mx-auto space-y-6">
        ...
        <div className="bg-gradient-to-r from-purple-600 via-blue-600 to-indigo-600 rounded-2xl shadow-xl p-8 text-white">
          ...
          <p className="text-purple-100 mt-2">Create a new product for your store</p>
        </div>
              ...
              <div>
                ...
                <div className="flex items-center gap-3">
                  ...
                  <label
                    ...
                    className="flex-1 px-4 py-3 bg-gradient-to-r from-purple-600 to-blue-600 text-white rounded-lg hover:shadow-lg transition cursor-pointer flex items-center justify-center gap-2"
                  >
